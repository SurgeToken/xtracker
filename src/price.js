...
import { SURGE_CONTRACT_ABI, SURGE_CONTRACT_ADDRESS, BSC_RPC_ENDPOINT, SURGE_USD_CONTRACT_ABI, SURGE_USD_CONTRACT_ADDRESS, SURGE_ETH_CONTRACT_ABI, SURGE_ETH_CONTRACT_ADDRESS } from './constants.js'
...
/**
 * Get the current price of a generic Surge contract in BNB
 * @param contractAddress The address of the contract to get the price from
 * @returns {Promise<string>}
 */
export async function getPriceInBnb(contractAddress) {
